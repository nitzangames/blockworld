...
export function showMainMenu({ worlds, displayName, version, defaultName, onOpen, onNew, onRename, onDelete, onJoin, onListRooms, onPrivacy, onListPublished, onVisit }) {
  ...
  let rooms = [];
  let view = 'home';           // 'home' | 'worlds' | 'gallery'
  let pollTimer = null;
  ...
  function renderHome() {
    ...
    el.innerHTML = `
      <div style="width:330px;max-width:92vw;padding:22px;background:#14171c;border-radius:16px">
        ...
        <button id="mm-edit" style="width:100%;height:44px;border:0;border-radius:8px;background:#3a3f47;color:#fff;font-weight:600;font-size:15px;cursor:pointer;margin-bottom:8px">Edit Existing →</button>
